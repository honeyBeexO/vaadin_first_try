...
import com.example.application.views.customerregistration.CustomerRegistrationView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        H1 appName = new H1("POS: Beauty’s UK");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Customer Registration ", LineAwesomeIcon.USER.create(),
